...
Ao preparar texto para busca ou indexação, há outra operação útil:  _case folding_ footnote:[NT: algo como "dobra" ou "mudança" de caixa.], nosso próximo assunto.
...
Lennart Regebro--um dos revisores técnicos da primeira edição desse livro--compartilha seu "Useful Mental Model of Unicode (UMMU)" (_Modelo Mental Útil do Unicode_) em um post curto, https://fpy.li/4-31["Unconfusing Unicode: What Is Unicode?" (_Desconfundindo o Unicode: O Que É O Unicode?_)] (EN).
